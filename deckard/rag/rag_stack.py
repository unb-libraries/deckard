...
class RagStack:
    ...
    def query(
        ...
        self.response_metadata.update({'vector_results': reranked_results.to_dict(orient='tight')})
        self.response_metadata.update({'sparse_results': sparse_results.to_dict(orient='tight')})
